...
class MoveRunnable implements Runnable {
    ...
    private void ghostMovement() {
        ...
        synchronized (GameStart.baton) {
            ArrayList<Ghost> ghost2List_dead = new ArrayList<>();
    ...
    private void collectCoin() {
        ...
        ArrayList<Coin> removeList = new ArrayList<>();
    ...
    private void collectDrink() {
        ...
        ArrayList<EnergyDrink> removeList = new ArrayList<>();
        Human human = map.getHuman();
    ...
    private void ghost1Move() {
        ...
        for (int i = 0; i < map.getGhost1List().size(); i++) {
            ...
            for (int j = 0; j < map.getGhost1List().size(); j++) {
                ...
                if (b.intersect(r)) {
                    b.setIntersect(map.getGhost1List().get(i).getHitbox(), r);
    ...
    private boolean gCollision(Ghost g) {
        boolean k = false;

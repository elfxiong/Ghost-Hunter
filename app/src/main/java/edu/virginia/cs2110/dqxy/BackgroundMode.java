    ...
    private void regularBomb() {
        ...
        findViewById(R.id.shopBtn1).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((TextView) findViewById(R.id.shopTxt1)).setText(String.format(Locale.US, "   %d", sharedPref.getInt("RegularBomb", 0)));
            }
        });
    ...
    private void discoBall() {
        ...
        findViewById(R.id.shopBtn3).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((TextView) findViewById(R.id.shopTxt3)).setText(String.format(Locale.US, "   %d", sharedPref.getInt("Disco", 0)));
            }
        });
